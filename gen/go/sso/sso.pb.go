...
type LoginRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`               // почта пользователя
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`         // пароль пользователя
	AppId    int32  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // ID сервиса, в котором логинится пользователь (сервисов может быть несколько)
}
...
type LoginResponse struct {
	...
	Token string `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // токен, который получает пользователь
}
...
type IsAdminResponse struct {
	...
	IsAdmin bool `protobuf:"varint,1,opt,name=is_admin,json=isAdmin,proto3" json:"is_admin,omitempty"` // является ли админом пользователь
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5a, 0x13, 0x56, 0x6f, 0x43, 0x39, 0x32, 0x35, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b,
